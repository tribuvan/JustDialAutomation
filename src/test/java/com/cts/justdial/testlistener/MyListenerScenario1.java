...
public class MyListenerScenario1 implements ITestListener {
    private ExtentReports extent;
    private ExtentTest test;

    @Override
    public void onStart(ITestContext context) {
        String reportPath = "test-output/ThirdPartyReports/ExtentReportScenario1.html";
    ...
    public void onTestFailure(ITestResult result) {
        WebDriver driver = Scenario1Runner.driver;
